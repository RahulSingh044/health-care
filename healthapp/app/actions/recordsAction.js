...
export async function addPrescribedMedicationAction(data) {
  try {
    const res = await axios.post(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/records/prescribed-record/upload`,
      data,
      {
...
export async function addPrescribedMedicationDoctorAction(data) {
  try {
    const res = await axios.post(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/records/prescribed-record/upload/doctor`,
      data,
      {
        headers: { "Content-Type": "multipart/form-data" },
      }
...
export async function deletePrescribedMedicationAction(id) {
  try {
    const res = await axios.delete(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/records/prescribed-record/${id}`,
      { withCredentials: true }
    );
    return res.data;
  } catch (error) {
...
export async function getMedicalRecordsAction() {
  try {
    const res = await axios.get(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/records/medical-record/all`,
      { withCredentials: true }
    );
    return res.data;
  } catch (error) {
...
export async function deleteMedicalRecords(id) {
  try {
    const res = await axios.delete(
      `${process.env.NEXT_PUBLIC_BACKEND_API_URL}/api/records/medical-record/${id}`,
      { withCredentials: true }
    );
    return res.data;
  } catch (error) {
